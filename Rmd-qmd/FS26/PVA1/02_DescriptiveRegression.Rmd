...
get_regression_table(lifeExp_model) %>% gt()
```
...
get_regression_table(score_model_interaction) %>% gt()
```
...
# Get regression table:
get_regression_table(score_model_parallel_slopes) %>% gt()
```
