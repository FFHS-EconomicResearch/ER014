...
* Kritischer Rationalismus (K. Popper): Eine Hypothese ($H_0$ oder $H_A$) nicht abzulehnen...
  * ...heißt nicht, sie zu akzeptieren!
  * ...sondern nur, dass wir (noch) nicht genügend Evidenz dafür haben. $H_0$ kann also durchaus auch im Fall $p\geq\alpha$: $H_0$ falsch sein.
...
## Vergleich mit traditionellen Hypothesentests
...
knitr::include_url('https://coggle.it/diagram/Vxlydu1akQFeqo6-/t/inference')
```
