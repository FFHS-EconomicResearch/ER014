...
`r fa('circle-right')` Problem der Identifikation
...
* Regressionsgleichungen
  * Während im Fall der deskriptiven Analyse $y_i = b_1+b_2\cdot x_i+e_i$, werden im Fall der stochastischen Analyse **griechische Symbole** verwendet.
  * Der Grund ist einfach: in der deskriptiven Analyse konnten wir die Koeffizienten $b_1$ und $b_2$ berechnen, da alle interessierenden Beobachtungen verfügbar waren.
  * Hingegen ist die Grundgesamtheit nicht beobachtbar, deshalb können wir die beiden
