...
* Idee: 
  * Wähle die Gerade, die von Streuung der beobachteten $y$-Werte möglichst viel "erklärt"
  * Minimiere den Anteil der unsystematischen Komponente $(e)$ (nicht erklärte Streuung)
...
## OLS-Regressionsgerade grafisch bestimmen
...
* Residuen als nicht erklärte Streuung
...
`r fa('exclamation-circle')` Hohes Maß na Kollinearität zwischen den Regressoren (vgl. Teil 3).
...
* Die **vertikalen gestrichelten Linien sind die Quartile**, die die Variable credit_limit in vier gleichgroße Gruppen unterteilen. Betrachten wir diese Quartile als Umwandlung unserer numerischen Variable credit_limit in eine kategoriale Variable "credit_limit bracket" mit vier Stufen. Dies bedeutet, dass
  ...
  * 25 % der Kreditlimits lagen über 5873 $. Ordnen wir diese 100 Personen der Gruppe "hohe" Kreditlimits zu.
